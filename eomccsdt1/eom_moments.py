...
def moments_aaa(projection):
    ...
    expressions = [
        BinaryExpression(-1.0, 1.0, Term('X', 'aa', 'BmJI', is_full=[False,True,False,False]), Term('T', 'aa', 'ACmK', is_full=[False,False,True,False])),
        BinaryExpression(-1.0, 1.0, Term('H', 'aa', 'BmJI', is_full=[False,True,False,False]), Term('R', 'aa', 'ACmK', is_full=[False,False,True,False])),
        BinaryExpression(+1.0, 1.0, Term('X', 'aa', 'BAJe', is_full=[False,False,False,True]), Term('T', 'aa', 'eCIK', is_full=[True,False,False,False])),
        BinaryExpression(+1.0, 1.0, Term('H', 'aa', 'BAJe', is_full=[False,False,False,True]), Term('R', 'aa', 'eCIK', is_full=[True,False,False,False])),
    ]
...
def moments_aab(projection):
    ...
    expressions = [
        BinaryExpression(+1.0, 1.0, Term('X', 'ab', 'BCeK', is_full=[False,False,True,False]), Term('T', 'aa', 'AeIJ', is_full=[False,True,False,False])),
        BinaryExpression(-1.0, 1.0, Term('X', 'ab', 'mCJK', is_full=[True,False,False,False]), Term('T', 'aa', 'ABIm', is_full=[False,False,False,True])),
        BinaryExpression(+1.0, 1.0, Term('X', 'ab', 'ACIe', is_full=[False,False,False,True]), Term('T', 'ab', 'BeJK', is_full=[False,True,False,False])),
        BinaryExpression(-1.0, 1.0, Term('X', 'ab', 'AmIK', is_full=[False,True,False,False]), Term('T', 'ab', 'BCJm', is_full=[False,False,False,True])),
        BinaryExpression(+1.0, 1.0, Term('X', 'aa', 'ABIe', is_full=[False,False,False,True]), Term('T', 'ab', 'eCJK', is_full=[True,False,False,False])),
        BinaryExpression(-1.0, 1.0, Term('X', 'aa', 'AmIJ', is_full=[False,True,False,False]), Term('T', 'ab', 'BCmK', is_full=[False,False,True,False])),
        BinaryExpression(+1.0, 1.0, Term('H', 'ab', 'BCeK', is_full=[False,False,True,False]), Term('R', 'aa', 'AeIJ', is_full=[False,True,False,False])),
        BinaryExpression(-1.0, 1.0, Term('H', 'ab', 'mCJK', is_full=[True,False,False,False]), Term('R', 'aa', 'ABIm', is_full=[False,False,False,True])),
        BinaryExpression(+1.0, 1.0, Term('H', 'ab', 'ACIe', is_full=[False,False,False,True]), Term('R', 'ab', 'BeJK', is_full=[False,True,False,False])),
        BinaryExpression(-1.0, 1.0, Term('H', 'ab', 'AmIK', is_full=[False,True,False,False]), Term('R', 'ab', 'BCJm', is_full=[False,False,False,True])),
        BinaryExpression(+1.0, 1.0, Term('H', 'aa', 'ABIe', is_full=[False,False,False,True]), Term('R', 'ab', 'eCJK', is_full=[True,False,False,False])),
        BinaryExpression(-1.0, 1.0, Term('H', 'aa', 'AmIJ', is_full=[False,True,False,False]), Term('R', 'ab', 'BCmK', is_full=[False,False,True,False])),
    ]
