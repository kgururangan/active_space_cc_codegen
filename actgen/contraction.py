...
def contract(expression, num_active):
    ...
    if len(expression.contracted) == 1:
        ...
        all_contractions = double_contraction(expression, order)
    elif len(expression.contracted) == 3:
        all_contractions = triple_contraction(expression, order)
    elif len(expression.contracted) == 4:
        all_contractions = quadruple_contraction(expression, order)
    elif len(expression.contracted) == 5:
        all_contractions = quintuple_contraction(expression, order)
    else:
...
def single_contraction(expression, order):
...
def double_contraction(expression, order):
...
def triple_contraction(expression, order):
...
def quadruple_contraction(expression, order):
...
def quintuple_contraction(expression, order):
